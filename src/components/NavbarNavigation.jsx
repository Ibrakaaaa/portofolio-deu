        ...
        <div className='flex  justify-between container items-center'>
            <nav className=' 	flex flex-wrap items-center text-base justify-center'>
                ...
                <a href='/' className=' "md:mr-auto flex flex-wrap items-center -mt-1 justify-center  min-h-2 text-white font-semibold text-xl '>Merkez Ibrahim</a>
                    ...
                    <li>
                <a className=' hover:text-white hidden md:inline-block' href='#projects'>Vergangene Arbeiten</a>
                    </li>
                    <li>
                <a  className=' hover:text-white hidden md:inline-block' href='#skills'>Kompetenzen</a>
                    </li>
                </ul>
            </nav>
