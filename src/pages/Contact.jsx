    ...
    <section id='contact' className='relative'>
      <div className='container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap'>
        ...
        <div className='bg-gray-900 flex flex-wrap relative py-6 rounded shadow-md '>
          ...
          <h2 className='font-semibold text-xs text-white uppercase tracking-widest'>ADRESSE</h2>
          <p className='mt-1'>
        ...
        >
          <h2 className='text-white tracking-normal font-semibold text-2xl pb-4'>Stellen Sie mich ein</h2>
          <p className='mb-2 text-sm'> Derzeit suche ich eine Position als Webentwickler. Kontaktieren Sie mich gerne, wenn Sie glauben, dass ich gut in Ihr Team passe! Bei weiteren Fragen oder Anfragen können Sie auch das Formular nutzen
...
.</p>
          ...
          <div className='relative mb-4 '>
          <label className='leading-7 text-sm text-gray-400'>Nachricht</label>
          ...
          <button className='bg-indigo-600 mt-4 py-2 rounded-lg text-white hover:bg-indigo-800 transition-colors duration-300 focus:bg-indigo-800 focus:outline-none focus:ring focus:ring-indigo-800 ' type='submit '>Absenden</button>
        </form>
      </div>
    </section>
  )
